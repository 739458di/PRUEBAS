    ...
    // Determinista y quirúrgico: SOLO si trae link (firma del clic) + frase de interés.
    {
        ...
        if (tieneLink && sinLinks.length <= 90 && esBoiler) {
            return {
                ...
                auto_id: autoResuelto ? autoResuelto.id : null, datos: {}, escalar: false,
...
module.exports = { entender, clasificar, resolverAutoDeterminista, esVendedor, INTENCIONES, SCHEMA };
