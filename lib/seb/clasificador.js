...
const INTENCIONES = [
    ...
    'fuera_alcance',       // cripto, envíos foráneos, cosas raras → escalar
    'otro'
];
...
- "continuacion" = el mensaje RESPONDE o afirma algo a la última pregunta de Seb (ej: "sí", "60", "a mi nombre", "hoy a las 6"). Si hay pregunta pendiente y el mensaje la contesta, es continuacion.
- Extrae datos concretos cuando existan (enganche "60"/"60 mil" → 60000; horas; fechas; confirmación sí/no).
- auto_id: SOLO un id del menú. null si no se puede saber.
- confianza "baja" si dudas entre intenciones o el mensaje es ambiguo. escalar=true si es queja, caso raro o fuera_alcance.
- Clasificas por significado, no por palabras ("estoy en otro estado" = foráneo, NO estado_auto).`;
