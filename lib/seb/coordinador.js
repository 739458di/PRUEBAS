...
const ACCIONES = {
    ...
    dueno: ['acepta', 'propone', 'no_puede_sin_hora', 'lo_piensa', 'ya_no_disponible', 'hablar_mario', 'pregunta_otra', 'cortesia'],
};
const DESC = {
    acepta: 'dice que SÍ CLARAMENTE a la propuesta pendiente (aunque lo diga con otras palabras o repita el día/hora). Un "ok" suelto o una duda NO es acepta',
