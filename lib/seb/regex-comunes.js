...
// Mensaje SIN contenido ("mmm", "ah", "jaja", "…"): no se contesta ni se escala; "ok/va/sí" NO son relleno (contestan a una pregunta)
const RE_RELLENO = /^[\s.,;:!?¡¿…-]*(m+|h?m+|hmm+|ah+|eh+|oh+|uh+|ay+|j[aeiou]j[aeiou]+(j[aeiou])*|xd+|lol|ok+ok|\.{2,})[\s.,;:!?¡¿…-]*$/i;
module.exports = { RE_RELLENO, RE_DISPONIBLE, RE_PETICION_POS, RE_HERR_SIN_DATOS, RE_PIDE_FOTOS, RE_PIDE_UBIC };
