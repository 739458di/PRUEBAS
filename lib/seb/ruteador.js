    ...
    properties: {
        herramientas: {
            ...
            items: {
                ...
                required: ['tool', 'enganche', 'presupuesto', 'plazo_meses', 'tipo', 'marca', 'similar_al_foco', 'economicos', 'campo', 'objetivo'],
...
HERRAMIENTAS:
- traer_inventario: pide ver autos del inventario — "qué similares tienes", "con ese enganche qué me alcanza", "algo más barato", "una camioneta", "qué más hay". Params: enganche/presupuesto (pueden venir del HISTORIAL si dice "ese enganche"), tipo, marca, similar_al_foco (parecidos al auto que ya ve), economicos (pide lo más barato).
...
async function ejecutar({ tel, herramientas, mesaRows, ej, convId }) {
    ...
    if (!terminaPregunta) {
        segmentos.push(mesaRows.length >= 2 ? '¿Cuál te late ir a ver primero? Te agendo de una vez' : '¿Te late venir a verlo y manejarlo? Te agendo de una vez');
    }
