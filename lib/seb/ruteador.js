    ...
    for (const h of herramientas) {
        ...
        if (h.tool === 'traer_inventario') {
            ...
            if (h.economicos && !hayCrit) {
                ...
                // SINTONÍA (orden owner): el maquillaje hace eco de SU palabra
                intro = /(similar|parecid)/i.test(String(texto || '')) ? 'Claro, de modelos similares también tenemos estos 🚗' : 'Va, con eso que me dices estas te van 🚗';
                if (!lista.length) {
