...
function esErrorDeterminista(e) {
    ...
    if (/SQLITE_BUSY|database is locked|turso_timeout|ECONN|ETIMEDOUT|EAI_AGAIN|socket|network|fetch failed|stream|WebSocket|HRANA/i.test(m)) return false;   // transitorios: sí se reintentan
