...
async function interceptar({ tenant: t, chat, ev, nuevo }) {
    ...
    if (c.estado === 'ronda' && c.fase !== 'espera_comprador') {
        ...
        if (E0 === 'se_complico') {
            ...
            await aMario(t, c, 'Al comprador se le complicó ' + (cu0 || 'la visita') + ' (' + N0.auto + '). La ronda quedó sin fecha hasta que diga otra.'); return { manejado: true, evento: 'se_complico_ronda' };
        }
