...
async function tickRecordatorios() {
    ...
    return { ok: true, matches: rows.length, enviados };
}
...
module.exports = {
    ...
    // producción
    ensureCitasMatch, enviarWA, registrarSolicitud,
    manejarMensajeDueno, manejarMensajeComprador, intentarMatchDirecto, senalManual, tickRecordatorios
};
