...
const TXT = {
    ...
    angosta_hoy: x => 'Va perfecto, ' + x.corto + ' nos vemos||Hoy estamos hasta las ' + x.cierre + (x.pin ? '. Te dejo otra vez la ubicación' : ''),
    fuera_horario: x => x.nombre_coma + 'ese día estamos ' + x.horario + '. ¿Alcanzas en ese horario?',
    r1: x => 'Qué tal' + x.n + ' ' + x.saludo + '||Seguimos pendientes ' + (/^entre /.test(x.corto) ? '' : 'para ') + x.corto + ', me avisas cualquier cosa',
    vispera_hora: x => 'Qué tal' + x.n + ' ' + x.saludo + '||Mañana sí nos vemos ' + x.alas + ' para ver ' + x.el + ' correcto?',
    vispera_sin_hora: x => 'Qué tal' + x.n + ' ' + x.saludo + '||A qué horas te esperamos mañana para ver ' + x.el + '?',
    ...
    dia_hora: x => 'Qué tal' + x.n + ' ' + x.saludo + '||Hoy sí nos vemos ' + x.alas + ' para ver ' + x.el + ' correcto?',
    dia_sin_hora: x => 'Qué tal' + x.n + ' ' + x.saludo + '||Hoy nos vemos para ver ' + x.el + ', estamos hasta las ' + x.cierre + '||A qué hora te esperamos?',
    ...
    dia_ultimo: x => 'Qué tal' + x.n + ' ' + x.saludo + '||Hoy nos vemos para ver ' + x.el + ', estamos hasta las ' + x.cierre + '||A qué hora te esperamos?',
    empujon: x => x.nombre_coma + 'todo bien para hoy?||Si se te complicó no pasa nada, lo movemos',
    confirma_dia: x => 'Perfecto, aquí nos vemos' + x.n,
