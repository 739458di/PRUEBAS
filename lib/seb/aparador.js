...
async function identificarAutoDeImagen(urlImg, autos) {
    try {
        ...
        const m = matchSenal(v, autos || []);            // único o nada — jamás adivinar
