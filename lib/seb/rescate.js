...
async function barrer({ tel, ahora, ultimoInTs, standby }) {
    try {
        ...
        for (const r of rows) {
            ...
            enviar.push({ folio: folioDe(r), telefono: r.telefono, segmentos, texto, foto: ctx.foto || null, tipo: r.tipo, etapa });
        }
        return enviar;
...
module.exports = { registrarTurno, registrarSalidaManual, barrer, preAvisos, estadoPanel, limpiar, interpretarPromesa, machote, ctxDe };
