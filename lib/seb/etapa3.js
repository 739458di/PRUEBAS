...
async function responderEtapa3Core({ texto, auto_id, conv_id, clasif }) {
    ...
    if (u === 'credito') {
        ...
        if (/apr(o|ue)b/.test(t)) return { escalar: true, motivo: 'pregunta la APROBACIÓN del crédito (proceso de cierre — tuyo)' };
        ...
        return { escalar: true, motivo: 'duda del PROCESO de crédito (explicarlo es venta — tuya)' };
    }
