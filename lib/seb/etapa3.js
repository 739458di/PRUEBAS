    ...
    if (contextoCita && auto_id) {
        ...
        if (hayObjecion) {
            if (obj === 'distancia' || esForaneoObjecion(t)) {
                const eF = conv_id ? await estadoConv(conv_id).catch(() => null) : null;
                return respForaneo(t, eF);
            }
