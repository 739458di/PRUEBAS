...
const TOOLS_DECL = [
    ...
    {
        name: 'cotizar',
        description: 'Cotización de financiamiento. (Hoy siempre indica que la cotización exacta la arma un humano.)',
        input_schema: { type: 'object', properties: { auto_id: { type: 'integer' }, enganche: { type: 'number' }, plazo_meses: { type: 'integer' } }, required: ['auto_id'] }
    }
];
const TOOL_IMPL = { ubicacion: H.ubicacion, autos_activos: H.autos_activos, info_auto: H.info_auto, cotizar: H.cotizar };
