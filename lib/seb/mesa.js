...
function detectarAccion(t, clasif) {
    ...
    if (/cot[ií]za|cotizar|cu[aá]nto (quedar[ií]a|sale|ser[ií]a|pagar[ií]a)|mensualidad|a \d{2} meses|de enganche|con \$?\d/i.test(t) || int === 'cotizar_credito') return 'cotizar';
...
module.exports = { responderMesa, cargarMesa, guardarMesa, engancheDeTexto, entradaMultiple, alinearAuto, nombradoEnTexto, infoEnPosesion, herramientaEnPosesion, paqueteAuto, detectarAccion, ejecutarAccionMesa, preguntaFamilia };
