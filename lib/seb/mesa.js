    ...
    try {
        ...
        if (RE_CREDITO_GENERAL.test(t)) {
            return { tipo: 'duda_general_credito', segmentos: [
                'Claro que sí',
                'Es por medio de HEY Banco, con muy buenas tasas. Mandas tus documentos, te cotizo, solicitamos el crédito, te dicen si apruebas en menos de 2 horas, ya aprobado tú decides cuándo firmas, y el enganche lo das a la entrega — no pagas nada hasta que se te entregue el auto',
