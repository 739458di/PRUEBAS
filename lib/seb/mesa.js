...
async function dudaGeneral({ texto, nombre, clasif, convId, tel }) {
    try {
        ...
        try { const { RE_RIESGO } = require('./doctrina.js'); if (RE_RIESGO.test(normz(t))) return null; } catch (e) { }
...
async function responderMesa({ tel, texto, clasif, convId }) {
    try {
        ...
        try { const { RE_RIESGO } = require('./doctrina.js'); if (RE_RIESGO.test(normz(String(texto || '')))) return null; } catch (e) { }
