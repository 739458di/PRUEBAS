...
async function autos_activos() {
    ...
    const rowsU = require('./contexto.js').filtrar(rows);   // universo ambiente → solo su catálogo
    return {
        ok: true,
        datos: rowsU.map(a => ({
            id: a.id,
...
module.exports = { autos_activos, info_auto, ubicacion, cotizar, enganche_minimo, planes, fotosDeAuto, reglasFin, bancoDeAuto };
