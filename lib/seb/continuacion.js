...
const RE_OTRA_DUDA = /(precio|cuesta|cuanto (vale|cuesta|piden)|que precio|color|kilometraje|\bkm\b|garantia|factura|chocad|detalle|motor|version|año|anio|aire|clima|4x4|fotos)/;
...
function universoCont(texto) {
    ...
    if (sUbi && !sFin && RE_OTRA_DUDA.test(t)) return null;   // #8 ubicación + otra duda no-manual → humano
